...
class Graph:
    ...
    def insert_vertex(self, element):
        ...
        v = Vertex(element)
        self._outgoing[____] = {}    # Agrega vértice al diccionario de salidas
        if self._directed:
            self._incoming[____] = {}  # Solo si es dirigido, agrega entrada
        return v

    def insert_edge(self, u, v, element):
        """Crea y agrega una arista entre dos vértices dados."""
        e = Edge(u, v, element)
        self._outgoing[____][____] = e   # Agrega arista a salidas
        self._incoming[____][____] = e   # Agrega arista a entradas
        return e

    def remove_edge(self, u, v):
        """Elimina la arista entre u y v, si existe."""
        if u in self._outgoing and v in self._outgoing[u]:
            del self._outgoing[____][____]
            del self._incoming[____][____]
    ...
    def remove_vertex(self, v):
        ...
        self._outgoing.pop(____, None)
        if self._directed:
            self._incoming.pop(____, None)

    def get_edge(self, u, v):
        """Retorna la arista desde u hasta v, o None si no existe."""
        return self._outgoing.get(____, {}).get(____)
